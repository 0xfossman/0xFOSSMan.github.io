...
function bodyonload()
{
   ...
   if (!x && p) p.innerHTML="<b><i>Bitte trage deinen Namen Oder Rufzeichen in das kästchen ein <a href='#please'>über dem Wasserfall</a> um in dich in der Unterhaltungsbox Kenntlich zu machen</i></b>";
...
function document_username() 
{
  ...
  if (x) {
    ...
    document.write('<a id="please"><span id="please1"><b><i>Bitte trage deinen Namen oder Rufzeichen ein (wird gespeichert für die zukünftigen zugriffe):<\/i><\/b></span> ');
    document.write('<input type="text" value="" name="username" onchange="setusernamecookie()" onclick=""></a>');
  }
}
